...
class RegisterUserIconViewController: UIViewController {
    ...
    func setupUserIconVertical() -> UIStackView {
        icon1 = RegisterUserIconButton(imageName: "UserIcon1")
        icon2 = RegisterUserIconButton(imageName: "UserIcon2")
        icon3 = RegisterUserIconButton(imageName: "UserIcon3")
        icon4 = RegisterUserIconButton(imageName: "UserIcon4")
        icon5 = RegisterUserIconButton(imageName: "UserIcon5")
        icon6 = RegisterUserIconButton(imageName: "UserIcon6")
        icon7 = RegisterUserIconButton(imageName: "UserIcon7")
        icon8 = RegisterUserIconButton(imageName: "UserIcon8")
        icon9 = RegisterUserIconButton(imageName: "UserIcon9")
        icon10 = RegisterUserIconButton(imageName: "UserIcon10")
        icon11 = RegisterUserIconButton(imageName: "UserIcon11")
        icon12 = RegisterUserIconButton(imageName: "UserIcon12")
        icon13 = RegisterUserIconButton(imageName: "UserIcon13")
        icon14 = RegisterUserIconButton(imageName: "UserIcon14")
        icon15 = RegisterUserIconButton(imageName: "UserIcon15")
